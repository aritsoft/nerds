...
function adammp_setup() {
	 ...
	 * to change 'adammp' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'adammp', ADAMMP_THEMEROOT . '/languages' );
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary Menu', 'adammp' ),	
        'footer_menu' => esc_html__( 'Footer Menu', 'adammp' ),
    ) );
...
function adammp_widgets_init() {
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Blog Right Sidebar', 'adammp' ),
		'id'            => 'blog-sidebar-right',
		'description'   => esc_html__( 'Add widgets here.', 'adammp' ),   
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Blog Left Sidebar', 'adammp' ),
    ...
    register_sidebar( array(
        'name' => esc_html__( 'Footer 1', 'adammp' ),
        'id' => 'footer-widget-1',
        'description' => esc_html__( 'The first footer widget area', 'adammp' ),
    ...
    register_sidebar( array(
        'name' => esc_html__( 'Footer 2', 'adammp' ),
        'id' => 'footer-widget-2',
        'description' => esc_html__( 'The second footer widget area', 'adammp' ),
        'before_widget' => '<div id="%1$s" class="%2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h2 class="foot_title">',
        'after_title' => '</h2>',
    ...
    register_sidebar( array(
        'name' => esc_html__( 'Footer 3', 'adammp' ),
        'id' => 'footer-widget-3',
        'description' => esc_html__( 'The third footer widget area', 'adammp' ),
        'before_widget' => '<div id="%1$s" class="%2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h2 class="foot_title">',
        'after_title' => '</h2>',    
    ...
    // Third Footer Widget Area, located in the footer. Empty by default.
    register_sidebar( array(
        'name' => esc_html__( 'Footer 4', 'adammp' ),
        'id' => 'footer-widget-4',
        'description' => esc_html__( 'The fourth footer widget area', 'adammp' ),
        'before_widget' => '<div id="%1$s" class="%2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h2 class="foot_title">',
        'after_title' => '</h2>',    
...
function adammp_custom_fonts_url() {
     ...
     */
    if ( 'off' !== _x( 'on', 'Google font: on or off', 'adammp' ) ) {
