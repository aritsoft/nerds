...
?>
    ...
    ?>
        ...
        <p class="hidden">
            <?php echo esc_html_e( 'No footer widgets','adammp' );?>
        </p>
...
?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            if( empty($adammp_footer_logo) ): ?>
                                    ...
                                    <?php else : ?>
                                    <a href="<?php echo esc_url( home_url( '/' ) ); ?>">
                                    <img src="<?php echo esc_url( $adammp_footer_logo ); ?>" alt="<?php echo esc_attr_e( 'Logo', 'adammp' ); ?>">
                                </a>
                                    <?php endif; ?>
                                </div>
                                <div class="footer-fun-text">
                                    <p>
                                        <?php esc_html_e( 'our social profile links.','adammp' );?>
                                    </p>
                                </div>
                                ...
                                <div class="social-bookmark-2-wrapper">
                                    <ul class="social-bookmark-2">
                                        ...
                                        <li class="fb">
                                            <a href="<?php echo esc_url( $adammp_fb_icon ); ?>">
                                        ...
                                        <li class="tweet">
                                            <a href="<?php echo esc_url( $adammp_tweet_icon ); ?>">
                                        ...
                                        <li class="insta">
                                            <a href="<?php echo esc_url( $adammp_inst_icon ); ?>">
                                        ...
                                        <li class="gplus">
                                            <a href="<?php echo esc_url( $adammp_gplus_icon ); ?>">
                                        ...
                                        <li class="linkd">
                                            <a href="<?php echo esc_url( $adammp_linked_icon ); ?>">
                                        ...
                                        <li class="ytube">
                                            <a href="<?php echo esc_url( $adammp_ytube_icon ); ?>">
                                ...
                                <div class="footer_menu">
                                    ...
                                    <div class="no_menu">
                                        <a href="<?php echo esc_url( $adammp_url.'nav-menus.php' ); ?>">
                                            <?php esc_html_e( 'Click here to add footer menu','adammp' );?>
                                        </a>
                                    </div>
                                    <?php } ?>
                                </div>
    ...
    <?php    
        $adammp_back_top_display = isset( adam_redux_variable()['back_top_enable'] ) ? adam_redux_variable()['back_top_enable'] : ''; 
    ?>
