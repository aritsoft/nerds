<?php
/**
 * Template part for displaying Video post format content in content.php.
 *
...
if( class_exists( 'cmb2' ) ) {
    $adammp_video_link = get_post_meta( get_the_ID(), 'adam_video_link', true );
}
...
?>
    ...
    <div <?php post_class( ); ?>>
        ...
        <?php     if ( is_single() ) { ?>
        <?php if ( ! empty ( $adammp_video_link ) ) : ?>
        <div class="embed-responsive embed-responsive-16by9">
            <?php global $wp_embed;
                    echo $wp_embed->run_shortcode('[embed]'. esc_url( $adammp_video_link ) .'[/embed]');
                ?>
        ...
        <div class="post-content">
            <div class="post-content-inner">
                <div class="post-meta">
                    ...
                    <span class="post-comment"><a href="#"><i class="icon-flag"></i><?php the_category( ', ' ); ?></a></span>
                </div>
                ...
                <div class="blog_desc">
                    ...
                    <p class="blog_tags">
                        <span class="list_label"> <?php esc_html_e( 'Tags:', 'adammp' );?> </span>
                        <?php the_tags( ' ', ' , ' ); ?>
                    </p>
                    <?php endif; ?>
                </div>
            ...
            <div class="post-footer-meta clearfix">
                ...
                <div class="read-more-wrapper">
                    <a href="<?php the_permalink(); ?>" class="read-more">
                        <?php esc_html_e( 'Read More', 'adammp' ); ?>
                    </a>
                </div>
            </div>
        </div>
