    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-4 col-sm-4">
            <div class="project-meta-wrapper">
                <h4>
                    <?php esc_html_e( 'information', 'adammp' ); ?> </h4>
                <ul class="single-portfolio-meta">
                    <?php if ( !empty ( $adammp_client_name ) ) : ?>
                    <li><i class="fa fa-user"></i><span> <?php esc_html_e( 'Client:', 'adammp' ); ?> </span>
                        <?php echo esc_html( $adammp_client_name, 'adammp' ); ?>
                    </li>
                    <?php endif; ?>
                    <?php if ( !empty ( $adammp_project_date ) ) : ?>
                    <li><i class="fa fa-calendar"></i><span> <?php esc_html_e( 'Date:', 'adammp' ); ?> </span>
                        <?php echo esc_html( $adammp_project_date, 'adammp' ); ?>
                    </li>
                    <?php endif; ?>
                    <?php if ( !empty ( $adammp_project_skills ) ) : ?>
                    <li><i class="fa fa-coffee"></i><span> <?php esc_html_e( 'Skills:', 'adammp' ); ?> </span>
                        <?php echo esc_html( $adammp_project_skills, 'adammp' ); ?>
                    </li>
                    <?php endif; ?>
                    <?php if ( !empty ( $adammp_project_demo ) ) : ?>
                    <li><i class="fa fa-link"></i><span> <?php esc_html_e( 'Demo:', 'adammp' ); ?> </span>
                        <a href="<?php echo esc_url( $adammp_project_demo ); ?>" target="_blank">
                            <?php esc_html_e( 'Live Link', 'adammp' ); ?>
                        </a>
                    </li>
                    <?php endif; ?>
                </ul>
        ...
        <div class="col-lg-3 col-md-4 col-sm-4">
            <div class="project-meta-wrapper">
                ...
                <ul class="single-portfolio-meta">
                    ...
                    <?php endif; ?>
                    <?php if ( !empty ( $adammp_project_skills ) ) : ?>
                    <li><i class="fa fa-coffee"></i><span> <?php echo esc_html_e( 'Skills:', 'adammp' ); ?> </span>
                        <?php echo esc_html( $adammp_project_skills, 'adammp' ); ?>
                    </li>
                    <?php endif; ?>
                    <?php if ( !empty ( $adammp_project_demo ) ) : ?>
