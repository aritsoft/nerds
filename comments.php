...
?>
	...
	if ( have_comments() ) : ?>
			...
			<?php
				...
				printf( // WPCS: XSS OK.
					...
					esc_html( _nx( 'One thought on &ldquo;%2$s&rdquo;', '%1$s thoughts on &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'nerds' ) ),
            ...
            <?php if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) : // Are there comments to navigate through? ?>
                ...
                <nav id="comment-nav-above" class="navigation comment-navigation">
                    ...
                    <h2 class="screen-reader-text"><?php esc_html_e( 'Comment navigation', 'nerds' ); ?></h2>
                    ...
                    <div class="nav-links">
                        ...
                        <div class="nav-previous">
                            ...
                            <?php previous_comments_link( esc_html__( 'Older Comments', 'nerds' ) ); ?>

                        </div>

                        <div class="nav-next">

                            <?php next_comments_link( esc_html__( 'Newer Comments', 'nerds' ) ); ?>
	...
	if ( ! comments_open() && get_comments_number() && post_type_supports( get_post_type(), 'comments' ) ) : ?>
                            ...
                            <p class="no-comments">
                                ...
                                <?php esc_html_e( 'Comments are closed.', 'nerds' ); ?>
